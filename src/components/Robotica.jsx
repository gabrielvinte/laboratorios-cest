...
import roboticaImage from '../assets/images/Robotica.jpg';
 ...
 */
function RoboticaRender({ id }, ref) {
  return (
    <section ref={ref} id={id} className="bg-white py-16 px-4 sm:px-10">
      <div className="container mx-auto">
        ...
        <div className="flex flex-col lg:flex-row items-center justify-center gap-x-16 lg:gap-x-[12rem] gap-y-10 lg:gap-y-0">
...
const Robotica = forwardRef(RoboticaRender);
